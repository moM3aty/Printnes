        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ParentMenu = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InternalNotes = table.Column<string>(type: "nvarchar(max)", maxLength: 5000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllowCustomSize = table.Column<bool>(type: "bit", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExtraType = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    SortOrder = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuantityTiers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_QuantityTiers_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductId = table.Column<int>(type: "int", nullable: false),
                    PaperOptionId = table.Column<int>(type: "int", nullable: false),
                    SizeOptionId = table.Column<int>(type: "int", nullable: false),
                    SidesOptionId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PricingMatrices_ProductOptions_PaperOptionId",
                        column: x => x.PaperOptionId,
                        principalTable: "ProductOptions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PricingMatrices_ProductOptions_SidesOptionId",
                        column: x => x.SidesOptionId,
                        principalTable: "ProductOptions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PricingMatrices_ProductOptions_SizeOptionId",
                        column: x => x.SizeOptionId,
                        principalTable: "ProductOptions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PricingMatrices_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SelectedExtrasJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Quantity = table.Column<int>(type: "int", nullable: false),
                    CalculatedUnitPrice = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                    ExtrasTotal = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                    ItemTotal = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                    DesignFileId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_DesignFileId",
                table: "OrderItems",
                column: "DesignFileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PricingMatrices_PaperOptionId",
                table: "PricingMatrices",
                column: "PaperOptionId");

            migrationBuilder.CreateIndex(
                name: "IX_PricingMatrices_ProductId",
                table: "PricingMatrices",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_PricingMatrices_SidesOptionId",
                table: "PricingMatrices",
                column: "SidesOptionId");

            migrationBuilder.CreateIndex(
                name: "IX_PricingMatrices_SizeOptionId",
                table: "PricingMatrices",
                column: "SizeOptionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuantityTiers_ProductId",
                table: "QuantityTiers",
                column: "ProductId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_OrderItems_UploadedFiles_DesignFileId",
                table: "OrderItems",
                column: "DesignFileId",
